...
// 商品選択時
#define INFO_PRODUCT_LIST    "\n【取扱商品】\n"
#define PROMPT_SELECT_PRODUCT  "\n購入する商品の番号を入力してください。\n"
#define ERROR_INVALID_PRODUCT ERROR_TAG "存在しない商品番号です。もう一度入力してください。\n"

// 硬貨投入時
#define PROMPT_MSG_COIN_10   "\n10円硬貨の枚数を入力してください。\n"
#define PROMPT_MSG_COIN_50   "\n50円硬貨の枚数を入力してください。\n"
#define PROMPT_MSG_COIN_100  "\n100円硬貨の枚数を入力してください。\n"
#define PROMPT_MSG_COIN_500  "\n500円硬貨の枚数を入力してください。\n"
#define ERROR_COIN_COUNT  ERROR_TAG "0以上の数値を入力してください。\n"

// 購入の処理時
#define INFO_ZERO_MONEY    "\n投入金額が0のためメニューに戻ります。\n"
#define INFO_LACK_MONEY    "\n投入金額が%d円不足しています。\n"
#define PROMPT_ADD_COINS    "追加で硬貨を投入してください。\n"
#define INFO_PURCHASE_OK  "\n【購入完了！】\n"
